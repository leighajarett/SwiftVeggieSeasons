...
let apple = Veggie(
    ...
    trivia: [
        Trivia("A peck of apples (that's a real unit of measurement!) weighs approximately how many pounds?", [
            "10 pounds",
            "20 pounds",
            "30 pounds"
        ], 0),
        ...
        Trivia("In Greek mythology, Paris gives a golden apple marked \"To the Fairest\" to a goddess. Which one?", [
            "Hera",
            "Athena",
            "Aphrodite"
        ], 2),
        ...
        Trivia("How long does it take a typical apple tree to produce its first fruit?", [
            "One to two years",
            "Four or five years",
            "Eight to ten years"
        ], 1),
        Trivia("Archaeological evidence of humans eating apples dates back how far?", [
            "500 C.E.",
            "2000 B.C.E.",
            "6500 B.C.E."
        ], 2),
...
let artichokes = Veggie(
    id: 2,
    name: "Artichokes",
    imageAssetPath: "artichoke",
    category: .flower,
...
let asparagus = Veggie(
    id: 3,
    name: "Asparagus",
    imageAssetPath: "asparagus",
    category: .fern,
    shortDescription: "It's been used as food and medicine for millennia.",
    accentColor: Color("green"),
    seasons: [.spring],
    ...
    trivia: [
        Trivia("The nodules at the tip of an asparagus spear are actually which part of the plant?", [
            "Seeds",
            "Leaves",
            "Protective scales"
        ], 1),
        ...
        Trivia("Asparagus spears have been observed growing how many inches in a single day?", [
            "1",
            "3",
            "6"
        ], 2),
...
let avocado = Veggie(
    ...
    trivia: [
        ...
        Trivia("The word avocado derives from 'ahuacatl,' found in which civilization?",[
                "Aztec",
                "Incan",
                "Sumerian"
            ],0),
        ...
        Trivia( "The first evidence of avocado consumption by humans dates back to what year?",[
                "2,000 B.C.",
                "6,000 B.C.",
                "10,000 B.C."
            ],2)
...
let blackberries = Veggie(
    id: 5,
    name: "Blackberries",
    imageAssetPath: "blackberry",
    ...
    trivia: [
        ...
        Trivia("The blackberry is the official fruit of which American state?", [
            "Washington",
            "Colorado",
            "Alabama"
        ], 2),
...
let cantaloupe = Veggie(
    id: 6,
    name: "Cantaloupe",
    imageAssetPath: "cantaloupe",
    ...
    trivia: [
        ...
        Trivia("The most expensive melons in Japan can sell for up to how much?", [
            "$100",
            "$1,000",
            "$10,000"
        ], 2)
...
let cauliflower = Veggie(
    id: 7,
    name: "Cauliflower",
    imageAssetPath: "cauliflower",
    ...
    trivia: [
        Trivia("The quote \"Cauliflower is nothing but cabbage with a college education\" is attributed to whom?", [
            "Mark Twain",
            "Cesar Romero",
            "Lucille Ball"
        ], 1),
        Trivia("The edible head of a cauliflower plant is sometimes called what?", [
            "The curd",
            "The cow",
            "The cudgel"
        ], 0),
        Trivia("Cauliflower is related closest to which of these other plants?", [
            "Mustard greens",
            "Apples",
            "Potatoes"
        ], 0),
...
let grapes = Veggie(
    ...
    trivia: [
        ...
        Trivia("About how many millions of tons of grapes are produced each year?", [
            "40",
            "80",
            "120"
        ], 1),
...
let green_pepper = Veggie(
    id: 11,
    name: "Green Pepper",
    imageAssetPath: "green_bell_pepper",
    category: VeggieCategory.stealthFruit,
...
let habanero = Veggie(
    ...
    trivia: [
        ...
        Trivia("Which of these is a pepper known to be hotter than the habanero?", [
            "Serrano pepper",
            "Hatch chile",
            "Pepper X"
        ], 2),
...
let kale = Veggie(
    ...
    trivia: [
        ...
        Trivia("One serving of kale provides what percentage of a typical person's requirement for vitamin K?", [
            "100%",
            "300%",
            "900%"
        ], 2)
...
let kiwi = Veggie(
    ...
    trivia: [
        ...
        Trivia("Compared to oranges, kiwi typically contain how much vitamin C?", [
            "Half as much",
            "About the same",
            "Twice as much"
        ], 2)
...
let lemons = Veggie(
    ...
    trivia:  [
      ...
      Trivia(
        "Which lemon variety is prized for its sweeter-than-average flavor?",
        [
          "Hookeye",
          "Meyer",
          "Minnesota Stomp",
...
let mushrooms =  Veggie(
    id: 18,
    name: "Mushrooms",
    imageAssetPath: "mushroom",
    ...
    trivia: [
      ...
      Trivia(
        "Morel mushrooms are particularly prized by cooks of which style of cuisine?",
        [
          "French",
          "Italian",
          "Japanese",
...
let nectarines = Veggie(
    id: 19,
    name: "Nectarines",
    imageAssetPath: "nectarine",
    category: VeggieCategory.stealthFruit,
    shortDescription: "A fuzzless relative of the peach, just as delicious.",
    accentColor:  Color("orange"),
    seasons: [Season.summer],
    vitaminAPercentage: 7,
    vitaminCPercentage: 17,
    servingSize: "1 medium nectarine",
    caloriesPerServing: 62,
    trivia:  [
      Trivia(
        "Which of these statements about nectarines is true?",
        [
          "They are always smaller than peaches.",
          "They are a hybrid of peaches and plums.",
          "They have more fuzz than peaches.",
        ],
        1
      ),
      Trivia(
        "What is the primary difference between peaches and nectarines?",
        [
          "Nectarines are sweeter than peaches.",
          "Nectarines have smoother skin than peaches.",
          "Nectarines are only available in yellow color.",
        ],
        1
      ),
      Trivia(
        "What is the main nutrient found in nectarines?",
        [
          "Iron",
          "Calcium",
          "Vitamin C",
...
let persimmons = Veggie(
    id: 20,
    name: "Persimmons",
    imageAssetPath: "persimmon",
    category: VeggieCategory.fruit,
...
let potatoes = Veggie(
    ...
    trivia:  [
      ...
      Trivia(
        "The world record for longest curly fry stands at how many inches?",
        [
          "38",
          "58",
          "78",
...
let radicchio = Veggie(
    id: 23,
    name: "Radicchio",
    imageAssetPath: "radicchio",
    category: VeggieCategory.leafy,
    ...
    trivia:  [
      Trivia(
        "Radicchio is a particularly good source of which mineral?",
        [
          "Manganese",
          "Mercury",
          "Molybdenum",
...
let strawberries = Veggie(
        id: 26,
        name: "Strawberries",
        imageAssetPath: "strawberry",
        category: VeggieCategory.berry,
...
let watermelon = Veggie(
        id: 29,
        name: "Watermelon",
        imageAssetPath: "watermelon",
        category: VeggieCategory.melon,
        ...
        trivia:  [
          ...
          Trivia(
            "Which nation is famous for growing watermelons in unusual shapes like cubes and hearts?",
            [
              "Armenia",
              "Japan",
              "Saudi Arabia",
...
let orange_pepper = Veggie(
        id: 30,
        name: "Orange Bell Pepper",
        imageAssetPath: "orange_bell_pepper",
        category: VeggieCategory.stealthFruit,
...
let veggies = [apple, artichokes, asparagus, blackberries, cantaloupe,
               cauliflower, endive, figs, grapes, green_pepper, habanero, kale, kiwi,
               lemons, limes, mangos, mushrooms, nectarines, persimmons, plums,
               watermelon, orange_pepper, tomato, tangelo, strawberries,squash, radishes,
               radicchio, potatoes
]
